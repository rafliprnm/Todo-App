...
if(localStorage.getItem("TO DO ITEMS")){
    ...
    itemLocalStorage.forEach(function(itemTodo){
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
            <h4>${itemTodo}</h4><span class="fs-3"><i class="bi bi-x-square-fill text-danger" id="delete-btn"></i></span>
        </li>`;
...
form.addEventListener("submit",function(event){
    listGroup.innerHTML += `
        <li class="list-group-item d-flex justify-content-between align-items-center">
            <h4>${inputUser.value}</h4><span class="fs-3"><i class="bi bi-x-square-fill text-danger" id="delete-btn"></i></span>
        </li>`;
